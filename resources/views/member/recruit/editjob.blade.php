...
<?php
$isQuestionsExisted = 'No';
if(count($questions)>0)
{
    $isQuestionsExisted = 'Yes'; 
}
                    ...
                    <div class="panel-body">
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="row">
                                            ...
                                            <select class="selectpicker" data-width="fit" name="company_name" id="company_name">
                                              ...
                                              document.getElementById('company_name').value = '<?php echo $jobrecord[0]->company_id;?>';
                                              </script>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                            <div class="input-icon">
                                                    <input type="text" class="form-control" name="job_title" id="job_title" value="<?php echo $jobrecord[0]->job_title;?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                             ...
                             <div class="col-md-4">
                                 ...
                                 <div class="form-group" >
                                     ...
                                     <div class="row">
                                         <div class="col-md-12">
                                         <div class="input-icon">
                                                 <input type="text" class="form-control" name="jobType" id="jobType" value="<?php echo $jobrecord[0]->jobType;?>">
                                             </div>
                                         </div>
                                     </div>
                                 </div>
                             ...
                             <div class="col-md-4">
                                 ...
                                 <div class="form-group" >
                                     ...
                                     <div class="row">
                                         ...
                                         <div class="col-md-6">
                                         <div class="input-icon">
                                                 <input type="text" class="form-control" name="minSalary" id="minSalary" value="<?php echo $jobrecord[0]->minSalary;?>">
                                         ...
                                         <div class="input-icon">
                                                 ...
                                                 <input type="text" class="form-control" name="maxSalary" id="maxSalary" value="<?php echo $jobrecord[0]->maxSalary;?>">
                          ...
                          <div class="col-md-4">
                              ...
                              <div class="form-group" >
                                  ...
                                  <div class="row">
                                      <div class="col-md-12">
                                      <div class="input-icon">
                                              <input type="text" class="form-control" name="industry" id="industry" value="<?php echo $jobrecord[0]->industry;?>">
                                          </div>
                                      </div>
                                  </div>
                              </div>
                              ...
                              <div class="form-group" >
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="input-icon">
                                              ...
                                              <script type="text/javascript">
                                              document.getElementById('workFromHome').value = '<?php echo $jobrecord[0]->workFromHome;?>';
                                              </script>
                                          </div>
                                      </div>
                                  </div>
                              ...
                              <div class="form-group" >
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="input-icon">
                                              ...
                                              <script type="text/javascript">
                                              document.getElementById('resumeRequired').value = '<?php echo $jobrecord[0]->resumeRequired;?>';
                                              </script>
                              ...
                              <div class="form-group" >
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="input-icon">
                                              ...
                                              <script type="text/javascript">
                                              document.getElementById('additionalDocs').value = '<?php echo $jobrecord[0]->additionalDocs;?>';
                                              </script>
                                          </div>
                                      </div>
                                  </div>
                      ...
                      <div class="row">
                              ...
                              <div class="form-group" >
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="input-icon">
                                              ...
                                              <script type="text/javascript">
                                              document.getElementById('additionalLinks').value = '<?php echo $jobrecord[0]->additionalLinks;?>';
                                              </script>
                                          </div>
                                      </div>
                                  </div>
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="row">
                                            ...
                                            <textarea class="textarea_editor form-control" rows="10" name="job_description"
                                                  id="job_description"><?php echo $jobrecord[0]->job_description;?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="row">
                                            ...
                                            <textarea class="textarea_editor form-control" rows="10" name="job_Responsibilities"
                                                  id="job_Responsibilities"><?php echo $jobrecord[0]->job_Responsibilities;?></textarea>
                                                </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="row">
                                            ...
                                            <textarea class="textarea_editor form-control" rows="10" name="job_Benefits"
                                                  id="job_Benefits"><?php echo $jobrecord[0]->job_Benefits;?></textarea>
                                                </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="row">
                                            ...
                                            <textarea class="textarea_editor form-control" rows="10" name="terms"
                                                  id="terms"><?php echo $jobrecord[0]->terms;?></textarea>
                                                </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class = "addQuestionDiv" style="margin-top:10px;">
                                       ...
                                       ?>
                                        <div class="row" style="margin-top:5px">
                                            <div class="col-md-12">
                                            <div class="input-icon">
                                                <input type="text" name="questions[]" style="width:95%;" value="<?php echo $question->questionName;?>">&nbsp;&nbsp;<span class="glyphicon glyphicon-minus-sign remove_field" style="cursor:pointer;"></span>
                                             </div>
                                                </div>
                                            </div>
                                            <?php } ?>
                        ...
                        <div class="form-actions" style="margin-top: 70px; margin-left:20px;">
                            <div class="row">
                                <div class="col-md-4">
                                    <input type="hidden" name="hdnJobId" id="hdnJobId" value="<?php echo $jobrecord[0]->id;?>">
...
function validateForm()
{
    ...
    if(isSubmit)
    {
       ...
       $.easyAjax({
            url: '{{route('member.recruit.updateJob')}}',
            container: '#storeJobs',
            type: "POST",
            ...
            success: function (response) {
                if (response.status == 'success') {
                    ...
                    var url = '{{ route('member.recruit.managejob')}}';
                     location.href = url;
...
<?php
if($isQuestionsExisted == 'Yes')
{
?>
<script type="text/javascript">
$("#isQuestionRequired").val(1);
$("#questionDiv").show();
$("#questionToggle").prop("checked", true);
</script>
<?php } ?>
@endpush
