        ...
        <div class="tab-content" id="task-detail-section">
            <div role="tabpanel" class="tab-pane fade active in" id="home1">
                <div class="col-xs-12" >
                    ...
                    @if(sizeof($task->tags))
                        <div class="col-xs-6 col-md-12 font-12">
                            <label class="font-12" for="">@lang('modules.tickets.tags')</label><br>
                            <span>
                                @foreach($task->tags as $key => $tag)
                                    {{ ucwords($tag->tag->tag_name) }} @if((sizeof($task->tags)-1) > $key) , @endif
                                @endforeach
                                    </span>
                        </div>
                    @endif
