...
<div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading"> @lang('modules.Paymentlinks.addPaymentLink')</div>
                    ...
                    <div class="panel-body">
                        {!! Form::open(['id'=>'createPaymentLink','class'=>'ajax-form','method'=>'POST']) !!}
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="purpose" id="purpose" class="form-control" autocomplete="nope">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-8    ">
                                        <div class="form-group">
                                            <label class="required">@lang('modules.Paymentlinks.PaymentLinkType')</label>
                                             ...
                                             <input type="radio" name="PaymentLinkType" id="PaymentLinkType"                                                    autocomplete="nope" value="1" onClick="displayNoOfCustomers(1);false;">&nbsp;@lang('modules.Paymentlinks.group')&nbsp;&nbsp;&nbsp;

                                            <input type="radio" name="PaymentLinkType" id="PaymentLinkType" 
                                                   autocomplete="nope" value="2" onClick="displayNoOfCustomers(2);false;">&nbsp;@lang('modules.Paymentlinks.individual')
                                ...
                                <div class="row" id="noOfCustomers" style="display:none;">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="required">@lang('modules.Paymentlinks.customerphone')</label>
                                             <input type="number" name="customerphone" id="customerphone" class="form-control"
                                                   autocomplete="nope">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                           ...
                                           <input name="expiredate" id="expiredate" type="date" min="2013-12-25">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-8    ">
                                        <div class="form-group">
                                            <label class="required">@lang('modules.Paymentlinks.PaymentType')</label>
                                             ...
                                             <input type="checkbox" name="paypal" id="paypal"                                                    autocomplete="nope" value="1">&nbsp;@lang('modules.Paymentlinks.paypal')&nbsp;&nbsp;&nbsp;

                                            <input type="checkbox" name="rozarpay" id="rozarpay" 
                                                   autocomplete="nope" value="1">&nbsp;@lang('modules.Paymentlinks.rozarpay')&nbsp;&nbsp;&nbsp;

                                            <input type="checkbox" name="stripe" id="stripe" 
                                                   autocomplete="nope" value="1">&nbsp;@lang('modules.Paymentlinks.stripe')
...
<script type="text/javascript">
       ...
       if(isSubmit)
    {
       ...
       $.easyAjax({
            url: '{{route('admin.savePaymentLink')}}',
