...
<div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading"> @lang('modules.PLSettings.PLSettings')</div>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label class="required">@lang('modules.PLSettings.buttonColor')</label>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label class="required">@lang('modules.PLSettings.buttonColor')</label>
                                             <input type="text" name="buttonColor" id="buttonColor" class="form-control"
                                                   autocomplete="nope" value="<?php echo $plSettings[0]->buttonColor;?>" data-jscolor="">
                                        </div>
                                    </div>
                                  ...
                                  <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label class="required">Text Color</label>
                                             <input type="text" name="textColor" id="textColor" class="form-control"
                                                   autocomplete="nope" value="<?php echo $plSettings[0]->textcolor;?>" data-jscolor="" >
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    function validateForm()
    {
       ...
       $.easyAjax({
            url: '{{route('admin.paymentlinks.siteSetting.saveSetting')}}',
    ...
    function validateEditForm()
    {
       ...
       $.easyAjax({
            url: '{{route('admin.paymentlinks.siteSetting.updateSetting')}}',
