...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"><i class="{{ $pageIcon }}"></i>Edit Pixels</h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
...
<div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">Edit Pixels</div>
                            ...
                            <div class="row" style="margin-left:15px;" id="questionDiv">
                                ...
                                <div class="form-group" >
                                            ...
                                            <div class="col-md-12">
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="input-icon">
                                                        <input type="text" name="pixelName" id="pixelName" style="width:95%;" value="<?php echo $pixels[0]->pixelName;?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-7">
                                                    ...
                                                    <div class="input-icon">
                                                        <textarea name="pixleCode" id="pixleCode" rows="3" cols="80"><?php echo $pixels[0]->pixelCode;?></textarea>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="form-actions" style="margin-top: 70px; margin-left:20px;">
                                        <div class="row">
                                            <div class="col-md-4">
                                            <input type="hidden" name="pixelID" id="pixelID" value="<?php echo $pixels[0]->id;?>">
