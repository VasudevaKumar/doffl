<div class="modal-header">
    ...
    <h4 class="modal-title">@lang('modules.files.fileGroups')</h4>
</div>
    ...
    <div class="portlet-body">
            ...
            <table class="table">
                ...
                @foreach($data['groups'] as $key=>$group)
                    <tr id="cat-{{ $group->id }}">
                        ...
                        <td>{{ ucwords($group->project_name) }}</td>
        ...
        <div class="form-body">
            ...
            <div class="row">
                <div class="col-xs-12 ">
                    <div class="form-group">
                        <label>@lang('modules.client.projectName')</label>
                        <select class="select2 form-control" data-placeholder="@lang('app.menu.projects') @lang('app.status')" id="project_id" name="project_id">
...
<script>
    ...
    $('.delete-category').click(function () {
        ...
        var url = "{{ route('admin.fileGroupCategory.destroy',':id') }}";
...
//                                    swal("Deleted!", response.message, "success");
    ...
    $('#save-group').click(function () {
        $.easyAjax({
            url: '{{route('admin.fileGroupCategory.store-group')}}',
            ...
            success: function (response) {
                if(response.status == 'success'){
                    if(response.status == 'success'){
                        ...
                        var content = '';
                        content += '<tr id = "cat-'+value.id+'"><td>'+response.data.key+'</td><td>'+value.name+'</td><td>'+value.project_name+'</td><td><a href="javascript:;" data-cat-id="'+value.id+'" class="btn btn-sm btn-danger btn-rounded delete-category">@lang("app.remove")</a></td></tr>';
