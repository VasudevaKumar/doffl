                    ...
                    <div class="panel-body">
                        ...
                        @endif
                            <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio radio-inline col-md-4">
                                                <input type="radio" name="chkfileType" id="personal"
                                                       value="2" onClick="checkProjectDropdown(this.value);">
                                ...
                                <div class="row" style="margin-bottom: 20px;" id="projects">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div style="margin-bottom: 10px;">
                                                <label class="control-label">@lang('modules.files.projectName')</label>
                                                <a class="mytooltip" href="javascript:void(0)"> <i class="fa fa-info-circle"></i><span class="tooltip-content5"><span class="tooltip-text3"><span class="tooltip-inner2">@lang('modules.file.sendUploadFileMessage')</span></span></span></a>
                                            </div>
                                            if(count($projects) > 0)
                                            <select class="select2 form-control"  name="project_id" id="project_id">
...
<script>
    ...
    $('#save-form').click(function () {
        $.easyAjax({
            url: '{{route('admin.fileGroupCategory.store-files')}}',
            container: '#saveFile',
            type: "POST",
            redirect: true,
            blockUI: true,
