...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"><i class="{{ $pageIcon }}"></i>Edit Article</h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
...
@section('content')
    ...
    {!! Form::open(['id'=>'updateArticle','class'=>'ajax-form storeTicket','method'=>'POST']) !!}
    <div class="form-body">
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="articleSubject" name="articleSubject" class="form-control" value="<?php echo $articleRecord[0]->articleTitle;?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="articleShortDescription" name="articleShortDescription" class="form-control" maxlength="250" value="<?php echo $articleRecord[0]->articleShortDescription;?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <textarea class="textarea_editor form-control" rows="10" name="articleDescription"  id="articleDescription">
                                                  <?php echo $articleRecord[0]->articleDescription;?>
                                                  </textarea>
                   ...
                   <div class="panel-footer text-right">
                        <div class="btn-group dropup">
                            ...
                            <input type="hidden" name="articleID" value="<?php echo $articleRecord[0]->id;?>">
                            <input type="hidden" name="categoryID" value="<?php echo $articleRecord[0]->category_id;?>">
                            <input type="hidden" name="existingFilePath" value="<?php echo $articleRecord[0]->articleFilePath;?>">
                        </div>
                    </div> 
                </div>
...
<script>
    ...
    $('#update-form').click(function () {
        $.easyAjax({
            url: '{{route('admin.knowledgebase.updateArticle')}}',
