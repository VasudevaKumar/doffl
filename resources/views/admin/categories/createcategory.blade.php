...
@section('content')
    ...
    {!! Form::open(['id'=>'storeCategory','class'=>'ajax-form storeTicket','method'=>'POST']) !!}
    <div class="form-body">
        <div class="row">
            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="subject" name="subject" class="form-control" maxlength="250">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="shortDescription" name="shortDescription" name="subject" class="form-control" maxlength="250">
                                    </div>
                                </div>
...
<script>
    ...
    $('#save-form').click(function () {
        $.easyAjax({
            url: '{{route('admin.knowledgebase.saveCategory')}}',
            container: '#storeCategory',
            type: "POST",
            redirect: true,
            blockUI: true,
            redirect: true,
            data: $('#storeCategory').serialize(),
