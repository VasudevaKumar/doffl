...
<ul class="nav tabs-vertical">
    ...
    <li><a href="{{ route('admin.knowledgebase.siteSetting') }}" class="waves-effect">@lang('app.menu.kb.kbSettings')</a></li>

    <li><a href="{{ route('admin.settings.mediaLinks') }}" class="waves-effect">@lang('app.menu.mediaLinks')</a></li>


    <li><a href="{{ route('admin.paymentlinks.siteSetting') }}" class="waves-effect">@lang('app.menu.paymenetLinks.payments')</a></li>
    
    <li><a href="{{ route('admin.bookings.siteSetting') }}" class="waves-effect">@lang('app.menu.bookings.bookings')</a></li>

    
    <li><a href="{{ route('admin.pixel') }}" class="waves-effect">@lang('app.menu.pixels')</a></li>
