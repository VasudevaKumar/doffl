    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        ...
        <ul class="nav" id="side-menu">
            ...
            @endif
   			...
   			@if(in_array('group_discussion',$modules))
            <li><a href="{{ route('member.messageGroup.messages') }}" class="waves-effect"><i class="fa fa-file fa-fw"></i> <span class="hide-menu">@lang('app.menu.groupDiscussion')</span></a></li>   
			@endif
			...
			@if(in_array('files',$modules) && $user->can('access_files'))
            <li><a href="{{ route('member.files.manage-files', '63a9f0ea7bb98050796b649e85481845') }}" class="waves-effect"><i class="fa fa-file fa-fw"></i> <span class="hide-menu">@lang('app.menu.files')</span></a></li>
			@endif

            @if(in_array('recruit',$modules))
            <li><a href="{{ route('member.recruit.managejob') }}" class="waves-effect"><i class="ti-user fa-fw"></i>@lang('app.menu.recruit.recruit')</a></li>
            @endif
			...
			@if(in_array('push',$modules) && $user->can('access_push'))
	            <li><a href="#" class="waves-effect"><i class="fa fa-bell fa-fw"></i> <span class="hide-menu">@lang('app.menu.pushSettings')</span><span class="fa arrow"></span></a>
	                <ul class="nav nav-second-level">
	                    <li><a href="{{ route('member.push.subscribers') }}">@lang('app.menu.subscribers')</a> </li>
	                    <li><a href="{{ route('member.push.new-notification') }}">@lang('app.menu.new-notification')</a> </li>
	                    <li><a href="{{ route('member.push.all-notifications') }}">@lang('app.menu.all-notifications')</a> </li>
	                    <li><a href="{{ route('member.push.new-campaign') }}">@lang('app.menu.new-campaign')</a> </li>
	                    <li><a href="{{ route('member.push.all-campaigns') }}">@lang('app.menu.all-campaigns')</a> </li>
	                </ul>
	            </li>
		@endif
			
			      <!-- 
@if(in_array('chat',$modules) && $user->can('access_chat')) 
<li><a href="{{ route('member.chat.chat-board') }}" class="waves-effect"><i class="fa fa-comment fa-fw"></i> <span class="hide-menu">@lang('app.menu.chat')</span><span class="fa arrow"></span></a>
	                <ul class="nav nav-second-level">
	                        <li><a href="{{ route('member.chat.chat-board') }}">@lang('app.menu.chat')</a> </li>
	                        <li><a href="{{ route('member.chat.missed-chats') }}">@lang('app.menu.MissedChats')</a> </li>
	                        <li><a href="{{ route('member.chat.ended-chats') }}">@lang('app.menu.EndedChats')</a> </li>
	                </ul>
	            </li>
@endif 
-->
