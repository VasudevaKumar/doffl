    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        ...
        <ul class="nav" id="side-menu">
            ...
            @if(in_array('clients',$modules) || in_array('leads',$modules))
                <li><a href="{{ route('admin.clients.index') }}" class="waves-effect"><i class="icon-people fa-fw"></i> <span class="hide-menu"> @lang('app.menu.customers') <span class="fa arrow"></span> </span></a>
                    <ul class="nav nav-second-level">
                        @if(in_array('clients',$modules))
                            <li><a href="{{ route('admin.clients.index') }}" class="waves-effect"><span class="hide-menu"> @lang('app.menu.clients') <span class="fa arrow"></span> </span> </a>
                             </li>
                        @endif
            ...
            <li><a href="{{ route('admin.urlshortener') }}" class="waves-effect"><i class="ti-user fa-fw"></i>@lang('app.menu.companySettings.shortener')</a></li>

            <li><a href="#" class="waves-effect"><i class="ti-user fa-fw"></i>@lang('app.menu.companySettings.subdomain')</a></li>

            <li><a href="{{ route('admin.knowledgebase') }}" class="waves-effect"><i class="ti-user fa-fw"></i>@lang('app.menu.kb.knowledgebase')</a></li>

            <li><a href="{{ route('admin.recruit.managejob') }}" class="waves-effect"><i class="ti-user fa-fw"></i>@lang('app.menu.recruit.recruit')</a></li>
            
            <li><a href="{{ route('admin.bookings') }}" class="waves-effect"><i class="ti-user fa-fw"></i>@lang('app.menu.bookingsSettings.bookings')</a></li>

            <li><a href="{{ route('admin.paymentLinks') }}" class="waves-effect"><i class="ti-user fa-fw"></i>@lang('app.menu.paymenetLinks.managePayments')</a></li>
            ...
            @if(in_array('employees', $modules) || in_array('attendance', $modules) || in_array('holidays', $modules) || in_array('leaves', $modules))
                <li><a href="{{ route('admin.employees.index') }}" class="waves-effect"><i class="ti-user fa-fw"></i> <span class="hide-menu"> @lang('app.menu.hr') <span class="fa arrow"></span> </span></a>
                    <ul class="nav nav-second-level">
            ...
            <li><a href="{{ route('admin.fileGroupCategory.manage-files') }}" class="waves-effect"><i class="fa fa-file fa-fw"></i> <span class="hide-menu">@lang('app.menu.files')</span></a></li>
            

            <li><a href="{{ route('admin.message-group.index') }}" class="waves-effect"><i class="fa fa-file fa-fw"></i> <span class="hide-menu">@lang('app.menu.groupDiscussion')</span></a></li>

             <li>
                    <a href="#" class="waves-effect"><i class="icon-calender fa-fw"></i> <span class="hide-menu">@lang('app.menu.surveys')</span> <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="{{ route('admin.surveyPages.manageSurveys') }} ">@lang('app.menu.createSurvey')</a></li>   
                            <li><a href="{{ route('admin.surveyPages.surveyRecord') }} ">@lang('app.menu.surveyRecord')</a></li>   
                            <li><a href="{{ route('admin.surveyPages.surveyList') }} ">@lang('app.menu.surveyList')</a></li>   
            ...
            <li><a href="{{ route('admin.faqs.index') }}" class="waves-effect"><i class="icon-docs fa-fw"></i> <span class="hide-menu"> @lang('app.menu.faq')</span></a></li>
