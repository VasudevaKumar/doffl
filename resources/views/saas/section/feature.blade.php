                ...
                @if($loop->iteration % 2 == 0)
                    <div class="sp-100 pt-0">
                        <div class="row align-items-center">
                            <div class="col-lg-6 order-lg-1 wow fadeIn d-none d-lg-block" data-wow-delay="0.2s">
                                <div class="mock-img">
                ...
                @else
                    <div class="sp-100">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6 wow fadeIn d-none d-lg-block" data-wow-delay="0.2s">
                                <div class="mock-img">
                                    <img src="{{ $value->image_url }}" alt="mockup">
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="sec-title mb-60">
                        <h3>{{ $frontDetail->feature_title }}</h3>
                        <p>{{ $frontDetail->feature_description }}</p>
                    </div>
                </div>
            </div>
