...
return array(
  ...
  'fileNotempty' => 'File should not be empty.',
  'fileDeleted' => 'File deleted successfully.',
  'groupAdded' => 'Group added successfully.',
  'groupDeleted' => 'Group deleted successfully.',
  'employeesRequiredForGroup' => 'Please select employees.',
  'removedEmployeeFromGroup' => 'Employee successfully removed from the group',
  'groupAssigned' => 'Group assigned to the employee successfully.',
  'groupDeactivated' => 'Group removed from the employee successfully.',
  'groupNotEmpty' => 'Group name should not be emtpty',
  'groupNospecial' => 'Group name should not have special characters',
  ...
  'surveyDeleted'=>'Survey was deleted',
  ...
  'questionInserted' => 'Questions has been created successfully',
  'stylesConfigured' => 'Styles are configured successfully',
  'urlConfigured' => 'URL is configured successfully',
  'surveyLinkExisted' => 'Survey link already existed',
  'welcome' =>
  array(
...
After that upload the favicons to public/favicon directory.',
 ...
 will update on select.',
  ...
  'ccnotblank' => 'Credit card should not be blank.',
  'totalAmountNotMatch' => 'Toal invoice amount should be match with credit card total amount',
  'testimonial' =>
  array(
  ...
  'fileUploadSuccessfully' => 'File has been uploaded successfully',
  ...
  'kb'=>
  array(
      'companyNotEmpty' => 'Company name should not be empty',
      'subjectNotEmpty' => 'Subject should not be empty',
      'descriptionNotEmpty' => 'Description should not be empty',
      'categoryCreated' =>'Category created successfully',
      'categoryUpated'=>'Category updated successfully',
      'categoryRemoved'=>'Category removed successfully',
      'articletitleNoEmpty'=>'Article title should not be empty',
      'articleDescNoEmpty'=>'Article description should not be empty',
      'articleCreated'=>'Article saved successfully',
      'articleUpated' => 'Article was successfully updated',
      'articleRemoved' => 'Article remove successfully',
      'generalSetting' => 'Site settings configured',
      'generalSettingUpdated' => 'Site settings updated',
      'ThemeSetting' => 'Site theme settings configured',
      'GoogleSetting' => 'Site google tracking configured',
      'categoryTitleNotEmpty' => 'Title should not be empty',
      'categoryDescriptionNotEmpty' => 'Category description should not be empty',
      'categoryShortDescriptionNotEmpty' => 'Category short description should not be empty',
      'articleShortDescNoEmpty' => 'Article short description should not be empty'

  ),
  'Recruit' => 
  array(
    'jobInserted' => 'Job inserted successfully',
    'noJobs'=>'No jobs found',
    'JobUpdated' => 'Job updated successfully',
    'jobDeleted' => 'Job deleted successfully',
    'medialinkssaved' => 'Media links saved successfully',
    'medialinksupdated' => 'Media links updated successfully'
  ),
  'pixel' =>
  array(
    'pixelInserted' => 'Pixel has been inserted successfully',
    'pixelUpdated' => 'Pixel has been updated successfully',
    'pixelDeleted' => 'Pixel has been deleted successfully'
  ),
  'Bookings' =>
  array(
    'bookingInserted' => 'Booking has been inserted successfully',
    'BookingUpdated' => 'Booking has been updated successfully',
    'DeleteBooking' => 'Booking has been deleted successfully',
    'bookingSiteInserted' => 'Booking site setting has been created',
    'bookingSiteUpdated' => 'Booking site setting has been updated',
    'Minutes30' => 'Minutes should be greater than 30',
    'DeleteSlot' => 'Booking slot has been deleted successfully'

   
  ),
  'PaymentLink' =>
  array(
    'paymentLinkInserted' => 'Payment Link has been inserted successfully',
    'paymentLinkUpdated' => 'Payment Link has been updated successfully',
    'paymentLinkBooking' => 'Payment Link has been deleted successfully',
    'paymentLinkSiteInserted' => 'Payment link site setting has been created',
    'paymentLinkSiteUpdated' => 'Payment link site setting has been updated',
