...
class SuperAdminDashboardController extends SuperAdminBaseController
{
    ...
    public function index()
    {
        ...
        $paystack = DB::table("paystack_invoices")
            ...
            ->selectRaw('paystack_invoices.id ,companies.company_name , packages.name as name, companies.package_type, "Razorpay" as method, paystack_invoices.pay_date as paid_on , "" as end_on,paystack_invoices.next_pay_date,paystack_invoices.created_at')
