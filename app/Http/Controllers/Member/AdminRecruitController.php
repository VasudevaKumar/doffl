...
class AdminRecruitController extends MemberBaseController
{
    //
    ...
    public function __construct() {
        ...
        $this->pageIcon = 'fa fa-file';
          ...
          $this->middleware(function ($request, $next) {
            if (!in_array('recruit', $this->user->modules)) {
                abort(403);
            }
            return $next($request);
        });
    ...
    public function index()
    {
        ...
        if (!$this->user->can('access_recruit')) {
            abort(403);
        }
        ...
        return view('member.recruit.index', $this->data);
    }
    ...
    public function managejob()
    {
        ...
        $this->jobs = DB::select("  SELECT 	
                    ...
                    ");
        return view('member.recruit.managejob', $this->data);
    }
    ...
    {   
        ...
        return view('member.recruit.editjob', $this->data);
    ...
    public function manageQuestions($id)
    {
        ...
        $this->jobQuestions = DB::select("  SELECT 	
                    ...
                    AND
                        a.jobID = ".$id."
                    ");
        return view('member.recruit.manageQuestions', $this->data);
    ...
    {
       $this->jobID = $id;
       return view('member.recruit.createQuestion', $this->data);
    }
    ...
    public function profilelist($id)
    {
        ...
        $this->jobAnswers = DB::select("  SELECT 	
                    ...
                    ");
        return view('member.recruit.profilelist', $this->data);
    ...
    public function profileview($id)
    {
        ...
        return view('member.recruit.profileview', $this->data);
    }
    ...
    public function mediaLinks(Request $request)
    {
        ...
        return view('member.recruit.addMediaLinks', $this->data);
    }
