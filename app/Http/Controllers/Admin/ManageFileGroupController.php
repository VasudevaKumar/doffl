...
class ManageFileGroupController extends AdminBaseController
{
    //
    ...
    public function manageFiles(Request $request)
    {
        ...
        return view('admin.user-file.manage-files', $this->data);
    }
    ...
    function addFiles(Request $request)
    {
       ...
       return view('admin.user-file.add-file', $this->data);
       //echo 'here';
       //exit();
    }
    ...
    function storeFiles(Request $request)
    {
        ...
        $returnData = [];
        return Reply::successWithData(__('messages.fileUploadSuccessfully'), $returnData);
